  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        >
          Your brand needs<br />better <span className="inline-flex items-center px-6 py-2 rounded-2xl text-primary-foreground relative overflow-hidden translate-y-3" style={{ background: 'linear-gradient(180deg, hsl(241 99% 66%) 0%, hsl(241 99% 56%) 100%)' }}><span className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_0%,rgba(255,255,255,0.35)_0%,transparent_60%)]" />content</span>
        </motion.h1>
